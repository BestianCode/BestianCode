...
DevOps and cloud engineer focused on practical infrastructure: reproducible environments, automation-first operations, and production reliability.

I build and maintain tooling around Kubernetes, Terraform, Ansible, observability, and cloud delivery pipelines.

---

### Focus

- Scalable AI/ML infrastructure and GPU-enabled platforms for cloud and hybrid environments
- Automation of infrastructure operations and delivery workflows with Terraform, Ansible, Helm, and GitOps
- Reusable IaC components for secure, high-performance, production-ready systems
- CI/CD pipelines for consistent, low-risk delivery across multi-cloud and on-prem setups
- Observability-first operations with metrics, logs, tracing, meaningful alerting, and incident-ready runbooks

---

### Tech I actively work with

![Kubernetes](https://img.shields.io/badge/Kubernetes-Platform-326CE5)
...
![Jenkins](https://img.shields.io/badge/Jenkins-Automation-D24939)
![GitOps](https://img.shields.io/badge/GitOps-Flux-5468FF)
...
This is only a small part of my public libraries and projects that I can publish.
